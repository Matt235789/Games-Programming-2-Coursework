...
float ScreenDisplay::getWidth() { return screenWidth; } //getters
float ScreenDisplay::getHeight() { return screenHeight; }
...
void ScreenDisplay::initDisplay()
{
	...
	sdlWindow = SDL_CreateWindow("Games Programming 2", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, (int)screenWidth, (int)screenHeight, SDL_WINDOW_OPENGL); // create window
